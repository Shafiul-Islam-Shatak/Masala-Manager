...
const ComeResturent = () => {
    return (
        <section className="max-w-[1440px] lg:w-3/4
        mx-auto mt-10 lg:mt-20">
            <div className="container flex flex-col justify-center lg:p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex items-center justify-center lg:p-6 mt-8 lg:mt-0 ">
