                ...
                <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">About Us</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Contact Us</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600"></a>
                                </li>
                        ...
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">126/2, Demra</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">+001233492</a>
                                </li>
