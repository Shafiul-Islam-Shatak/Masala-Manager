                ...
                <div>
                    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl">
                        ...
                        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                            ...
                            <button onClick={() => handleSocialLogIn(googleLogin)} className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg   hover:bg-blue-200  w-full">
                                <div className="px-4 py-2"  >
                                    <FcGoogle></FcGoogle>
                                </div>
                                <span className="w-5/6 px-4 py-3 font-bold text-center">Sign in with Google</span>
                            </button>
                            <button onClick={() => handleSocialLogIn(githubLogin)} className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-blue-200 w-full">
                                <div className="px-4 py-2"  >
                                    <FaGithub></FaGithub>
                                </div>
                            ...
                            <div>
                                <form onSubmit={handleLogIn}>
                                    <div className="mt-4">
                                        ...
                                        <input name='email' className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300" type="email" />
                                    </div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <input name='password' className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg   focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"  type={showPassword ? 'password' : 'text'} />
                                            {
                                                showPassword ?
                                                    <IoEyeOffSharp onClick={() => { setShowPassword(!showPassword) }} className="-ml-7 text-black "></IoEyeOffSharp> :
                                                    <FaEye onClick={() => { setShowPassword(!showPassword) }} className="-ml-7 text-black"></FaEye>
                                            }
                                        </div>
                                    </div>
                            ...
                            <div className="flex items-center justify-between mt-4">
                                ...
                                <Link to='/reg' className="text-xs text-gray-500 uppercase  hover:underline">or sign up</Link>
